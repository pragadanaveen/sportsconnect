...
const App = () => {
  ...
  const handleAddPress = () => {
    if (activeTab === 'Teams') {
      navigation.navigate('CreateTeam'); // Navigate to the CreateTeam screen
    }
    if (activeTab === 'Groups') {
              ...
              <View key={index} style={styles.cardContainer}>
                <View style={styles.profileContainer}>
                  ...
                  <View style={styles.profileTextContainer}>
                    ...
                    <Text style={styles.playerInfo}onPress={handleCardPress3}>Are we playing today?</Text>
                  </View>
                </View>
                <View style={styles.notificationContainer}>
                  <Text style={styles.timeCard} onPress={handleCardPress3}>10:30 AM</Text>
                  <View style={[styles.notificationBadge, { backgroundColor: 'green' }]} >
                    <Text style={styles.notificationText}onPress={handleCardPress3}>2</Text>
                  </View>
                </View>
              </View>
            ))}
              ...
              (team, index) => (
                <View key={index} style={styles.cardContainer}>
                  <View style={styles.profileContainer}>
                    ...
                    />
                    <View style={styles.profileTextContainer}>
                      <Text style={styles.playerName}onPress={handleCardPress2}>{team.name}</Text>
                      <Text style={styles.playerInfo} onPress={handleCardPress2}>Team chat message here...</Text>
                    </View>
                  </View>
                  <View style={styles.notificationContainer}>
                    <Text style={styles.timeCard2}onPress={handleCardPress2}>10:30 AM</Text>
                    {team.notifications > 0 && (
                      <View
                        style={[styles.notificationBadge, { backgroundColor: 'green' }]}>
                        <Text style={styles.notificationText}onPress={handleCardPress2}>
                          {team.notifications}
                        </Text>
                      </View>
                    )}
